...
module "wandb_infra" {
  ...
  network_public_subnets   = var.public_subnets
  network_private_subnets  = var.private_subnets
  network_database_subnets = var.database_subnets
